...
```
git clone https://https://github.com/Ksundramjan2024/Docker-Hero
cd  examples
```
...
```
docker build -t ksundramjan2024/my-first-docker-image:latest .
```
...
```
    ...
    Successfully tagged ksundramjan2024/my-first-docker-image:latest
```
...
ksundramjan2024/my-first-docker-image   latest    960d37536dcd   26 seconds ago   467MB
...
```
docker run -it ksundramjan2024/my-first-docker-image
```
...
```
docker push ksundramjan2024/my-first-docker-image
```
...
The push refers to a repository [docker.io/ksundramjan2024/my-first-docker-image]
896818320e80: Pushed
b8088c305a52: Pushed
69dd4ccec1a0: Pushed
